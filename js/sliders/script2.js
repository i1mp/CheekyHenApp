...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container2").wowSlider({effect:"basic_linear",prev:"",next:"",duration:20*100,delay:20*100,width:610,height:406,autoPlay:false,playPause:false,stopOnHover:false,loop:false,bullets:0,caption:true,captionEffect:"fade",controls:true,onBeforeStep:0,images:0});